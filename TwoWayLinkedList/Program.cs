...
namespace Structures
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            minions.Add(new Minion(1, "Michael", 16, 1));
            minions.Add(new Minion(2, "William", 15, 3));
            minions.Add(new Minion(3, "Jane", 17, 2));
            minions.Add(new Minion(4, "Jessie", 19, 4));
            minions.Add(new Minion(6, "Lucas", 18, 5));
            minions.InsertBefore(new Minion(5, "Slim Shady", 48, 313), 1);
