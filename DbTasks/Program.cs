...
namespace DbTasks
{
    class Program
    {
        static string connectionString = "Server=localhost;Database=Minions;Trusted_Connection=True";
        ...
        private static bool DoesVillainExist(int id)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
            using (connection)
        ...
        private static bool DoesVillainHasMinions(int id)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
            using (connection)
        ...
        private static bool DoesVillainExist(string name)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
            using (connection)
        ...
        private static bool DoesTownExist(string name)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
            using (connection)
        ...
        static void Task4()
        {
            ...
            if (!DoesVillainExist(villainName))
            {
